...
import aero.sita.asl.tasks.routers.ChannelFileRouter;
 ...
 *
 */
public class ChannelFileRouterTest {

	private ChannelFileRouter router;
	...
	public void routeInvalidMessage() {
		...
		String channel = router.handleRouting(message);
